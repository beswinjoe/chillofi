...
app.get('/api/playlist', (req, res) => {
  ...
  res.json({ mood, name: pl.name, video: pl.video, tracks: pl.tracks });
});

// Cycle to next playlist (MUST be before :mood route)
...
app.get('/api/shuffle', (req, res) => {
  ...
  res.json({ mood, name: pl.name, video: pl.video, tracks: tracksCopy });
});
